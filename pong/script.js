...
var paddleSpeed = 5,
  ...
  rightScore = 0,
  paused = 1,
  pauseAfterPoint = 2000, //Anzahl an ms Pause nach einem Punkt
  pauseTimer = pauseAfterPoint, //wird nach einem Punkt bis 0 runtergezählt 
  gameStarted = 0,
  gameVisible = 0,
  gameFps = 60,
...
function manageTimer(){
    ...
    timerStatus = Math.ceil((pauseTimer*3)/pauseAfterPoint);
    if (pauseTimer <= 0) {
        paused = 0;
        pauseTimer = pauseAfterPoint;
    }
}
